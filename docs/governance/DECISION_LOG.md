...
## ADR-008 — Baseline research may produce a no-go result

**Decision:** the baseline slice succeeds either by beating mandatory naïve baselines under frozen geographic and temporal holdouts, or by publishing a documented insufficiency/no-go result and abstaining from unsupported forecasting.
**Reason:** scientific integrity is more important than manufacturing a positive model claim.
